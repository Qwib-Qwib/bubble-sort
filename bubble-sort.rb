def bubble_sort(array)
  ...
  partially_sorted_array.pop  #This command and the previous two are for optimization purpose. Since we know the last value in each iteration will be sorted, there no point to iterate on it, so it's taken out of the array to be sorted and saved for the final return. 
